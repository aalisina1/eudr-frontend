 ...
 * former plain Batch detail page (unchanged route, `/sourcing/[id]`;
  ...
  if (error || !po) {
    return (
      <div className="space-y-4">
        <Button variant="ghost" size="sm" onClick={() => router.push("/sourcing")} className="-ml-2 gap-1.5 text-muted-foreground">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          {ready ? (
            ...
            <Button onClick={() => router.push(`/submissions?po=${po.id}`)} className="gap-1.5">
