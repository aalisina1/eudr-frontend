import { AlertTriangle, CheckCircle2, Clock, FileText, Send, XCircle, type LucideIcon } from "lucide-react";
 ...
 *
 * `icon` mirrors the Claude Design prototype's status-badge treatment
 * (CheckCircle/Send/AlertTriangle/FileText per status) — purely visual.
 */
